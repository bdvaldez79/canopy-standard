...
// Unsplash Source API — free, no key needed, perfect for GitHub projects
const UNSPLASH_IMAGES = {
“Professional Hose-End Sprayer”: “https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=600&q=80”,
“Digital Soil Moisture Meter”: “https://images.unsplash.com/photo-1585320806297-9794b3e4eeae?w=600&q=80”,
“Heavy-Duty Nursery Cart”: “https://images.unsplash.com/photo-1617576683096-00fc8eecb3af?w=600&q=80”,
};
...
const imgUrl = UNSPLASH_IMAGES[product.name as keyof typeof UNSPLASH_IMAGES];
...
src={imgUrl}
alt={product.name}
className={`w-full h-48 object-cover transition-opacity duration-500 ${imgLoaded ? "opacity-100" : "opacity-0"}`}
...
<p className="text-gray-600 mb-2">Smart tools for plant care & pest control systems</p>
